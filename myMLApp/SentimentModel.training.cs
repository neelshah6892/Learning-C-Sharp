...
namespace MyMLApp
{
    ...
    {
        public const string RetrainFilePath =  @"D:\Github\Learning-C-Sharp\myMLApp\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=9,MinimumExampleCountPerLeaf=37,NumberOfTrees=4,MaximumBinCountPerFeature=449,FeatureFraction=0.99999999,LearningRate=0.252554697928978,LabelColumnName=@"col1",FeatureColumnName=@"Features"}),labelColumnName: @"col1"))      
